      ...
      <div className="blog__container grid">
        <div className="blog__card">
          <div className="blog__thumb">
            ...
            <a href="ddd"><img src={Image1} alt="" className="blog__img" /></a>
          </div>
        ...
        <div className="blog__card">
          <div className="blog__thumb">
            <a href="sss"><span className="blog__category">Tutorial</span></a>
            <a href="ddd"><img src={Image2} alt="" className="blog__img" /></a>
          </div>
          <div className="blog__details">
        ...
        <div className="blog__card">
          <div className="blog__thumb">
            <a href="sss"><span className="blog__category">Business</span></a>
            <a href="ddd"><img src={Image3} alt="" className="blog__img" /></a>
          </div>
          <div className="blog__details">
